...
C
    ...
    1 CONTINUE
      ...
      xn(i)=xnew
      yn(j)=ynew
      BREAL(I,J)=sin(pi*ynew/yl)*
     1   ( 2.285e4*cos(4.*pi*xnew/xl) +
     1    1.322e3*sin(4.*pi*xnew/xl) )
     1    +5.1523e-2*(ynew-yl/2)
    2 CONTINUE
      DO J=1,N2
